let MidChampList = ['Aatrox', 'Ahri', 'Akali', 'Akshan', 'Annie', 'Aurelion Sol', 'Azir', 'Anivia', 'Cassiopeia', 'Corki', 'Diana', 'Ekko', 'Fizz', 'Galio', 'Jayce', 'Kassadin', 'Katarina', 'Leblanc', 'Lissandra', 'Lucian', 'Lux', 'Malzahar', 'Nekko', 'Orianna', 'Pantheon', 'Pyke', 'Qiyana', 'Renekton', 'Rumble', 'Ryze', 'Swain', 'Sylas', 'Syndra', 'Talliyah', 'Talon', 'Twisted Fate', 'Veigar', 'Velkoz', 'Viktor', 'Vladimir', 'Xerath', 'Yasuo', 'Yone', 'Zed', 'Ziggs', 'Zilean', 'Zoe', 'Gangplank', 'Heimerdinger', 'Zyra'];
let TopChampList = ['Aatrox', 'Akali', 'Camile', 'Cassiopeia', 'Chogath', 'Darius', 'Dr. Mundo', 'Fiora', 'Gangplank', 'Garen', 'Gnar', 'Gwen', 'Heimerdinger', 'illaoi', 'Irelia', 'Jax', 'Jayce', 'Karma', 'Kayle', 'Kennen', 'Kled', 'Malphite', 'Maokai', 'Mordekaiser', 'Nasus', 'Olaf', 'Ornn', 'Pantheon', 'Poppy', 'Quinn', 'Renekton', 'Rengar', 'Riven', 'Rumble', 'Ryze', 'Sett', 'Shen', 'Singed', 'Sion', 'Sylas', 'Tahm Kench', 'Teemo', 'Tryndamere', 'Urgot', 'Vayne', 'Vladimir', 'Volibear', 'Wukong', 'Warwick', 'Yasuo', 'Yone', 'Yorick', 'Zac'];
let JungleChampList = ['Amumu', 'Belveth', 'Chogath', 'Diana', 'Dr. Mundo', 'Ekko', 'Elise', 'Evelyn', 'Fiddlesticks', 'Gragas', 'Graves', 'Hecarin', 'Ivern', 'Jarvan', 'Jax', 'Kartus', 'Kayn', 'Khazix', 'Kindred', 'LeeSin', 'Lillia', 'Master Yi', 'Mordekaiser', 'Nidalee', 'Nocturne', 'Nunu', 'Olaf', 'Poppy', 'Rammus', 'Reksai', 'Rengar', 'Sejuani', 'Sett', 'Shaco', 'Shyvana', 'Skarner', 'Talliyah', 'Trundle', 'Udyr', 'Vi', 'Viego', 'Volibear', 'Warwick', 'Wukong', 'XinZao', 'Zac'];
...
function SelectedBtn(id) {
  document.getElementById('mid').style.boxShadow = '';
  document.getElementById('top').style.boxShadow = '';
  document.getElementById('jgl').style.boxShadow = '';
  document.getElementById('adc').style.boxShadow = '';
  document.getElementById('supp').style.boxShadow = '';
  document.getElementById('all').style.boxShadow = '';
  document.getElementById(id).style.boxShadow = 'rgba(255, 255, 255, 0.837) 0px -50px 36px -28px inset';
}
function mudarBtn() {
  starBtn.style.display='none';
  acptBtn.style.display='inline';
...
function voltarBtn() {
  ...
  acptBtn.style.display='none';
  rfsBtn.style.display='none';
}
function abrirSite() {
  window.open(site);
}
