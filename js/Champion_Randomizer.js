let MidChampList = ['Aatrox', 'Ahri', 'Akali', 'Akshan', 'Annie', 'Aurelion Sol', 'Azir', 'Anivia', 'Cassiopeia', 'Corki', 'Diana', 'Ekko', 'Fizz', 'Galio', 'Jayce', 'Kassadin', 'Katarina', 'Leblanc', 'Lissandra', 'Lucian', 'Lux', 'Malzahar', 'Nekko', 'Orianna', 'Pantheon', 'Pyke', 'Qiyana', 'Renekton', 'Rumble', 'Ryze', 'Swain', 'Sylas', 'Syndra', 'Talliyah', 'Talon', 'Twisted Fate', 'Veigar', 'Velkoz', 'Viktor', 'Vladimir', 'Xerath', 'Yasuo', 'Yone', 'Zed', 'Ziggs', 'Zilean', 'Zoe', 'Gangplank', 'Heimer', 'Zyra'];
